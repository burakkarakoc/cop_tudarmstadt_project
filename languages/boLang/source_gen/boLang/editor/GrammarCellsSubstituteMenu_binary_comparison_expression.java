...
public class GrammarCellsSubstituteMenu_binary_comparison_expression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_binary_comparison_expression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_xe03c6_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "binary_comparison_expression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_xe03c6_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.binary_comparison_expression$c5;
    }
  }
