...
public class GrammarCellsSubstituteMenu_boolean_type extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_boolean_type() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ibha0m_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "boolean_type", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ibha0m_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.boolean_type$UQ;
    }
  }
