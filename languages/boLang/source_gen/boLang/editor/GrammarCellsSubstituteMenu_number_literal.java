...
public class GrammarCellsSubstituteMenu_number_literal extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_number_literal() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_cny1ga_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "number_literal", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_cny1ga_a extends GrammarCellsSubstituteMenuPart {
    @Override
