...
public class GrammarCellsSubstituteMenu_statement_container extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_statement_container() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_t5u462_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "statement_container", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_t5u462_a extends GrammarCellsSubstituteMenuPart {
    @Override
