...
/*package*/ class Root_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "LangStart");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_30aiet_c0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new contentsListHandler_30aiet_b1a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_contents");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class contentsListHandler_30aiet_b1a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public contentsListHandler_30aiet_b1a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(contentsListHandler_30aiet_b1a.this.getNode(), LINKS.contents$NnI8));
      try {
