...
public class GrammarCellsSubstituteMenu_arithmetic_binary_expression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_arithmetic_binary_expression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_bjkzku_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "arithmetic_binary_expression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_bjkzku_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.arithmetic_binary_expression$5i;
    }
  }
