...
public class GrammarCellsSubstituteMenu_variables extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_variables() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_umx919_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "variables", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_umx919_a extends GrammarCellsSubstituteMenuPart {
    @Override
