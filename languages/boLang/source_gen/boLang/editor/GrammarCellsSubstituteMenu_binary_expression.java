...
public class GrammarCellsSubstituteMenu_binary_expression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_binary_expression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_6iwx71_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "binary_expression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_6iwx71_a extends GrammarCellsSubstituteMenuPart {
    @Override
