...
public class GrammarCellsSubstituteMenu_string_literal extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_string_literal() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_9rzha6_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "string_literal", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_9rzha6_a extends GrammarCellsSubstituteMenuPart {
    @Override
