...
public class GrammarCellsSubstituteMenu_equals_expression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_equals_expression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_upi2mm_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "equals_expression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_upi2mm_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.equals_expression$FJ;
    }
  }
