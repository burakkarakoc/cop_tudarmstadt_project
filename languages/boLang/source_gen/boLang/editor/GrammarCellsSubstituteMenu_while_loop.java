...
public class GrammarCellsSubstituteMenu_while_loop extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_while_loop() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_qf64c7_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "while_loop", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_qf64c7_a extends GrammarCellsSubstituteMenuPart {
    @Override
