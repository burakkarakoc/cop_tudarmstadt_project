...
public final class if_statement__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x69cdfdddbb404ec3L, 0x88aa7abaa38e4365L, 0x573f104dc0ece2a4L, "boLang.structure.if_statement");
  ...
  /*package*/ static Iterable<SNode> getStatements_id5sZ44R0N6cD(@NotNull SNode __thisNode__) {
    return SLinkOperations.getChildren(__thisNode__, LINKS.then$M4$$);
  }

  /*package*/ if_statement__BehaviorDescriptor() {
  }
