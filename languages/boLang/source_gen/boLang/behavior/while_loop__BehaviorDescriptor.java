...
public final class while_loop__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x69cdfdddbb404ec3L, 0x88aa7abaa38e4365L, 0x4d3932e9a11d52cL, "boLang.structure.while_loop");
  ...
  /*package*/ static Iterable<SNode> getStatements_id5sZ44R0N6cD(@NotNull SNode __thisNode__) {
    return SLinkOperations.getChildren(__thisNode__, LINKS.content$ajXE);
  }

  /*package*/ while_loop__BehaviorDescriptor() {
  }
