...
public final class else_statement__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x69cdfdddbb404ec3L, 0x88aa7abaa38e4365L, 0x4d3932e99eedb4fL, "boLang.structure.else_statement");
  ...
  /*package*/ static Iterable<SNode> getStatements_id5sZ44R0N6cD(@NotNull SNode __thisNode__) {
    return SLinkOperations.getChildren(__thisNode__, LINKS.content$9YE6);
  }

  /*package*/ else_statement__BehaviorDescriptor() {
  }
