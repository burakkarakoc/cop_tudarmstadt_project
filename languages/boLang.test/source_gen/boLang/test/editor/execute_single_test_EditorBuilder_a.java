...
/*package*/ class execute_single_test_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public execute_single_test_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_1pd6eu_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_1pd6eu_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.suite$yJq4;
    ...
    provider.setNoTargetText("<no suite>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.suite$yJq4);
    }
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "->");
    editorCell.setCellId("Constant_1pd6eu_d0");
  ...
  private EditorCell createRefCell_1() {
    final SReferenceLink referenceLink = LINKS.test$vLAr;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
    ...
    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.test$vLAr);
    }
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, false);
    editorCell.getStyle().putAll(style);
